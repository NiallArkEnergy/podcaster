...
var _user$project$Podcast$podcastEncoder = function (pod) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'author',
				_1: _elm_lang$core$Json_Encode$string(pod.author)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'description',
					_1: _elm_lang$core$Json_Encode$string(pod.description)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'image',
						_1: _elm_lang$core$Json_Encode$string(pod.image)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'link',
							_1: _elm_lang$core$Json_Encode$string(pod.link)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'title',
								_1: _elm_lang$core$Json_Encode$string(pod.title)
							},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									_0: 'url',
									_1: _elm_lang$core$Json_Encode$string(pod.url)
								},
								_1: {ctor: '[]'}
							}
						}
...
var _user$project$Podcast$view = function (_p0) {
	var _p1 = _p0;
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('card col-12 col-md-4 col-lg-3 col-xs-2'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$Podcast$PodcastDescription = F6(
	function (a, b, c, d, e, f) {
		return {author: a, description: b, image: c, link: d, title: e, url: f};
	});
var _user$project$Podcast$podcastDescriptionDecoder = A7(
	_elm_lang$core$Json_Decode$map6,
	_user$project$Podcast$PodcastDescription,
...
var _user$project$Podcast$feedDecoder = _elm_lang$core$Json_Decode$maybe(
	A2(_elm_lang$core$Json_Decode$field, 'feed', _user$project$Podcast$podcastDescriptionDecoder));

var _user$project$Storage$addSubscription = _elm_lang$core$Native_Platform.outgoingPort(
	'addSubscription',
	function (v) {
		return v;
	});
var _user$project$Storage$loadSubscription = _elm_lang$core$Native_Platform.outgoingPort(
	'loadSubscription',
	function (v) {
		return null;
	});
var _user$project$Storage$receiveSubscription = _elm_lang$core$Native_Platform.incomingPort('receiveSubscription', _elm_lang$core$Json_Decode$string);

var _user$project$Subscriptions_Search$searchPodcasts = function (term) {
	var url = A2(
		F2(
			function (x, y) {
			...
			A2(
				...
				_elm_lang$core$Json_Decode$list(
					_elm_lang$core$Json_Decode$maybe(
						A2(_elm_lang$core$Json_Decode$field, 'feedUrl', _elm_lang$core$Json_Decode$string))))));
};
var _user$project$Subscriptions_Search$tempView = function (str) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
...
var _user$project$Subscriptions_Search$Model = F4(
	function (a, b, c, d) {
		return {searchParam: a, searchResult: b, fetchQue: c, podcasts: d};
	});
var _user$project$Subscriptions_Search$PodcastDescription = F6(
	function (a, b, c, d, e, f) {
		return {author: a, description: b, image: c, link: d, title: e, url: f};
	});
var _user$project$Subscriptions_Search$feedDecoder = _elm_lang$core$Json_Decode$maybe(
	A2(
		_elm_lang$core$Json_Decode$field,
		'feed',
		A7(
			_elm_lang$core$Json_Decode$map6,
			_user$project$Subscriptions_Search$PodcastDescription,
			A2(_elm_lang$core$Json_Decode$field, 'author', _elm_lang$core$Json_Decode$string),
			A2(_elm_lang$core$Json_Decode$field, 'description', _elm_lang$core$Json_Decode$string),
			A2(_elm_lang$core$Json_Decode$field, 'image', _elm_lang$core$Json_Decode$string),
			A2(_elm_lang$core$Json_Decode$field, 'link', _elm_lang$core$Json_Decode$string),
			A2(_elm_lang$core$Json_Decode$field, 'title', _elm_lang$core$Json_Decode$string),
			A2(_elm_lang$core$Json_Decode$field, 'url', _elm_lang$core$Json_Decode$string))));
var _user$project$Subscriptions_Search$getDescription = function (_p0) {
	return _elm_lang$http$Http$toTask(
		function (url) {
			return A2(_elm_lang$http$Http$get, url, _user$project$Subscriptions_Search$feedDecoder);
		}(
			A2(
				F2(
					function (x, y) {
...
var _user$project$Subscriptions_Search$SearchResult = function (a) {
	return {ctor: 'SearchResult', _0: a};
};
var _user$project$Subscriptions_Search$Fail = function (a) {
	return {ctor: 'Fail', _0: a};
};
var _user$project$Subscriptions_Search$Fetching = {ctor: 'Fetching'};
var _user$project$Subscriptions_Search$Init = {ctor: 'Init'};
var _user$project$Subscriptions_Search$init = {
	searchParam: '',
	searchResult: _user$project$Subscriptions_Search$Init,
	fetchQue: {ctor: '[]'},
	podcasts: {ctor: '[]'}
};
var _user$project$Subscriptions_Search$AddSubscription = function (a) {
	return {ctor: 'AddSubscription', _0: a};
};
var _user$project$Subscriptions_Search$viewResults = function (_p1) {
	var _p2 = _p1;
	return A2(
		_elm_lang$html$Html$div,
		{
								...
								_0: A2(
									_elm_lang$html$Html$button,
									{
										...
										_0: _elm_lang$html$Html_Events$onClick(
											_user$project$Subscriptions_Search$AddSubscription(_p2)),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
...
var _user$project$Subscriptions_Search$viewContent = function (_p3) {
	var _p4 = _p3;
	var _p5 = _p4.searchResult;
	switch (_p5.ctor) {
		case 'SearchResult':
			return A2(
				_elm_lang$html$Html$div,
				...
				A2(_elm_lang$core$List$map, _user$project$Subscriptions_Search$viewResults, _p5._0));
		case 'Fail':
		...
		default:
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Search content'),
					_1: {ctor: '[]'}
				});
	}
};
var _user$project$Subscriptions_Search$SearchFail = function (a) {
	return {ctor: 'SearchFail', _0: a};
};
var _user$project$Subscriptions_Search$SearchSuccess = function (a) {
	return {ctor: 'SearchSuccess', _0: a};
};
var _user$project$Subscriptions_Search$update = F2(
	function (msg, mdl) {
		var _p6 = msg;
		switch (_p6.ctor) {
			case 'UpdateSearchParam':
				return {
					ctor: '_Tuple2',
			...
			case 'SearchSuccess':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						mdl,
						{
							searchResult: _user$project$Subscriptions_Search$SearchResult(_p6._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'SearchFail':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						mdl,
						{
							searchResult: _user$project$Subscriptions_Search$Fail(_p6._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'SearchPodcasts':
				...
				if (_p7 === 'Enter') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							mdl,
							{searchResult: _user$project$Subscriptions_Search$Fetching}),
						_1: A2(
							_elm_lang$core$Task$attempt,
							function (res) {
								var _p8 = res;
								if (_p8.ctor === 'Ok') {
									return _user$project$Subscriptions_Search$SearchSuccess(_p8._0);
								} else {
									return _user$project$Subscriptions_Search$SearchFail(
							...
							A2(
								...
								A2(
									...
									function (_p9) {
										return _elm_lang$core$Task$sequence(
											A2(_elm_lang$core$List$map, _user$project$Subscriptions_Search$getDescription, _p9));
									},
									A2(
										_elm_lang$core$Task$map,
										_elm_lang$core$List$filterMap(_elm_lang$core$Basics$identity),
										_user$project$Subscriptions_Search$searchPodcasts(mdl.searchParam)))))
					};
				} else {
			...
			default:
				return {
					ctor: '_Tuple2',
					_0: mdl,
					_1: _user$project$Storage$addSubscription(
						A2(
							_elm_lang$core$Json_Encode$encode,
							0,
							_user$project$Podcast$podcastEncoder(_p6._0)))
				};
		}
	});
var _user$project$Subscriptions_Search$SearchPodcasts = function (a) {
	return {ctor: 'SearchPodcasts', _0: a};
};
var _user$project$Subscriptions_Search$UpdateSearchParam = function (a) {
	return {ctor: 'UpdateSearchParam', _0: a};
};
var _user$project$Subscriptions_Search$view = function (mdl) {
	var _p10 = mdl;
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
					...
					_0: A2(
						_elm_lang$html$Html$input,
						{
							...
							_0: A2(
								_elm_lang$html$Html_Events$on,
								'change',
								A2(_elm_lang$core$Json_Decode$map, _user$project$Subscriptions_Search$UpdateSearchParam, _elm_lang$html$Html_Events$targetValue)),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html_Events$on,
									...
									A2(
										_elm_lang$core$Json_Decode$map,
										_user$project$Subscriptions_Search$SearchPodcasts,
					...
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html$button,
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(
									_user$project$Subscriptions_Search$SearchPodcasts('Enter')),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
			...
			_1: {
				ctor: '::',
				_0: _user$project$Subscriptions_Search$viewContent(_p10),
				_1: {ctor: '[]'}
			}
		});
};

var _user$project$Subscriptions_View$view = function (mdl) {
	var _p0 = mdl;
	switch (_p0.ctor) {
		case 'Init':
			return _elm_lang$html$Html$text('Init');
		case 'Loaded':
			return A2(
				_elm_lang$html$Html$div,
				{ctor: '[]'},
				A2(_elm_lang$core$List$map, _user$project$Podcast$view, _p0._0));
		default:
			return _elm_lang$html$Html$text(_p0._0);
	}
};
var _user$project$Subscriptions_View$FailedLoad = function (a) {
	return {ctor: 'FailedLoad', _0: a};
};
var _user$project$Subscriptions_View$Loaded = function (a) {
	return {ctor: 'Loaded', _0: a};
};
var _user$project$Subscriptions_View$update = F2(
	function (msg, mdl) {
		var _p1 = msg;
		var _p2 = _p1._0;
		if (_p2.ctor === 'Ok') {
			return {
				ctor: '_Tuple2',
				_0: _user$project$Subscriptions_View$Loaded(_p2._0),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		} else {
			return {
				ctor: '_Tuple2',
				_0: _user$project$Subscriptions_View$FailedLoad(_p2._0),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		}
	});
var _user$project$Subscriptions_View$Init = {ctor: 'Init'};
var _user$project$Subscriptions_View$init = {
	ctor: '_Tuple2',
	_0: _user$project$Subscriptions_View$Init,
	_1: _user$project$Storage$loadSubscription(
		{ctor: '_Tuple0'})
};
var _user$project$Subscriptions_View$LoadPodcasts = function (a) {
	return {ctor: 'LoadPodcasts', _0: a};
};
var _user$project$Subscriptions_View$subscriptions = function (model) {
	var _p3 = model;
	if (_p3.ctor === 'Init') {
		return _user$project$Storage$receiveSubscription(
			function (_p4) {
				return _user$project$Subscriptions_View$LoadPodcasts(
					A2(
						_elm_lang$core$Json_Decode$decodeString,
						_elm_lang$core$Json_Decode$list(_user$project$Podcast$podcastDescriptionDecoder),
						_p4));
			});
	} else {
		return _elm_lang$core$Platform_Sub$none;
...
var _user$project$Subscriptions_Subscriptions$Search = function (a) {
	return {ctor: 'Search', _0: a};
};
var _user$project$Subscriptions_Subscriptions$View = function (a) {
	return {ctor: 'View', _0: a};
};
var _user$project$Subscriptions_Subscriptions$init = function () {
	var _p0 = _user$project$Subscriptions_View$init;
	var mdl = _p0._0;
	var cmd = _p0._1;
	return {
		ctor: '_Tuple2',
		_0: _user$project$Subscriptions_Subscriptions$View(mdl),
		_1: cmd
	};
}();
var _user$project$Subscriptions_Subscriptions$ToggleView = {ctor: 'ToggleView'};
var _user$project$Subscriptions_Subscriptions$viewToggle = function (mdl) {
	var _p1 = mdl;
	if (_p1.ctor === 'View') {
		return A2(
			_elm_lang$html$Html$button,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(_user$project$Subscriptions_Subscriptions$ToggleView),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
var _user$project$Subscriptions_Subscriptions$SearchMsg = function (a) {
	return {ctor: 'SearchMsg', _0: a};
};
var _user$project$Subscriptions_Subscriptions$update = F2(
	function (msg, mdl) {
		var _p2 = msg;
		switch (_p2.ctor) {
			case 'ToggleView':
				...
				if (_p3.ctor === 'View') {
					return {
						ctor: '_Tuple2',
						_0: _user$project$Subscriptions_Subscriptions$Search(_user$project$Subscriptions_Search$init),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					var _p4 = _user$project$Subscriptions_View$init;
					var x = _p4._0;
					var y = _p4._1;
					return {
						ctor: '_Tuple2',
						_0: _user$project$Subscriptions_Subscriptions$View(x),
						_1: y
					};
				}
			case 'ViewMsg':
				var _p5 = mdl;
				if (_p5.ctor === 'View') {
					var _p6 = A2(_user$project$Subscriptions_View$update, _p2._0, _p5._0);
					var updateMdl = _p6._0;
					var cmd = _p6._1;
					return {
						ctor: '_Tuple2',
						_0: _user$project$Subscriptions_Subscriptions$View(updateMdl),
						_1: cmd
					};
				} else {
					return {ctor: '_Tuple2', _0: mdl, _1: _elm_lang$core$Platform_Cmd$none};
			...
			default:
				var _p7 = mdl;
				if (_p7.ctor === 'Search') {
					var _p8 = A2(_user$project$Subscriptions_Search$update, _p2._0, _p7._0);
					var updateMdl = _p8._0;
					var cmd = _p8._1;
					return {
						ctor: '_Tuple2',
						_0: _user$project$Subscriptions_Subscriptions$Search(updateMdl),
						_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Subscriptions_Subscriptions$SearchMsg, cmd)
					};
				} else {
					return {ctor: '_Tuple2', _0: mdl, _1: _elm_lang$core$Platform_Cmd$none};
				}
...
var _user$project$Subscriptions_Subscriptions$view = function (mdl) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$Subscriptions_Subscriptions$viewToggle(mdl),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					},
					{
						...
						_0: function () {
							var _p9 = mdl;
							if (_p9.ctor === 'View') {
								return _user$project$Subscriptions_View$view(_p9._0);
							} else {
								return A2(
									_elm_lang$html$Html$map,
									_user$project$Subscriptions_Subscriptions$SearchMsg,
									_user$project$Subscriptions_Search$view(_p9._0));
							}
						}(),
						_1: {ctor: '[]'}
					}),
...
var _user$project$Subscriptions_Subscriptions$ViewMsg = function (a) {
...
var _user$project$Subscriptions_Subscriptions$subscriptions = function (model) {
	...
	if (_p10.ctor === 'View') {
		return A2(
			_elm_lang$core$Platform_Sub$map,
			_user$project$Subscriptions_Subscriptions$ViewMsg,
			_user$project$Subscriptions_View$subscriptions(_p10._0));
	} else {
		return _elm_lang$core$Platform_Sub$none;
	}
};

var _user$project$Main$tabToString = function (tab) {
	var _p0 = tab;
	switch (_p0.ctor) {
		case 'Episodes':
			return 'Episodes';
...
var _user$project$Main$Downloads = {ctor: 'Downloads'};
var _user$project$Main$Episodes = {ctor: 'Episodes'};
var _user$project$Main$Subscriptions = function (a) {
	return {ctor: 'Subscriptions', _0: a};
};
var _user$project$Main$init = function () {
	var _p1 = _user$project$Subscriptions_Subscriptions$init;
	var mdl = _p1._0;
	var cmd = _p1._1;
	return {
		ctor: '_Tuple2',
		_0: {
			tab: _user$project$Main$Subscriptions(mdl)
		},
		_1: cmd
	};
}();
var _user$project$Main$subInit = function () {
	var _p2 = _user$project$Subscriptions_Subscriptions$init;
	var mdl = _p2._0;
	var cmd = _p2._1;
	return {
		ctor: '_Tuple2',
		_0: _user$project$Main$Subscriptions(mdl),
		_1: cmd
	};
}();
var _user$project$Main$SubscriptionsSwitch = function (a) {
	return {ctor: 'SubscriptionsSwitch', _0: a};
};
var _user$project$Main$subscriptions = function (model) {
	var _p3 = model.tab;
	if (_p3.ctor === 'Subscriptions') {
		return A2(
			_elm_lang$core$Platform_Sub$map,
			_user$project$Main$SubscriptionsSwitch,
			_user$project$Subscriptions_Subscriptions$subscriptions(_p3._0));
	} else {
		return _elm_lang$core$Platform_Sub$none;
	}
};
var _user$project$Main$update = F2(
	function (msg, mdl) {
		...
		if (_p4.ctor === 'SwitchTo') {
			...
			var _p5 = mdl.tab;
			if (_p5.ctor === 'Subscriptions') {
				var _p6 = A2(_user$project$Subscriptions_Subscriptions$update, _p4._0, _p5._0);
				var subMdl = _p6._0;
				var cmd = _p6._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						mdl,
						{
							tab: _user$project$Main$Subscriptions(subMdl)
						}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$SubscriptionsSwitch, cmd)
				};
			} else {
				return {ctor: '_Tuple2', _0: mdl, _1: _elm_lang$core$Platform_Cmd$none};
			}
...
var _user$project$Main$viewTab = F2(
	function (_p7, activeTab) {
		var _p8 = _p7;
		var _p9 = _p8._0;
		var active = _elm_lang$core$Native_Utils.eq(
			_user$project$Main$tabToString(_p9),
			_user$project$Main$tabToString(activeTab)) ? 'active' : '';
		return A2(
			_elm_lang$html$Html$li,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('nav-itemu'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$a,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(
								_user$project$Main$SwitchTo(_p8)),
							_1: {ctor: '[]'}
						}
					},
					{
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: A2(_user$project$Main$viewTab, _user$project$Main$subInit, model.tab),
							_1: {
								ctor: '::',
								_0: A2(
									_user$project$Main$viewTab,
									{ctor: '_Tuple2', _0: _user$project$Main$Episodes, _1: _elm_lang$core$Platform_Cmd$none},
									model.tab),
								_1: {
									ctor: '::',
									_0: A2(
										_user$project$Main$viewTab,
										{ctor: '_Tuple2', _0: _user$project$Main$Downloads, _1: _elm_lang$core$Platform_Cmd$none},
										model.tab),
									_1: {ctor: '[]'}
								}
							}
			...
			_1: {
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: function () {
							var _p10 = model.tab;
							if (_p10.ctor === 'Subscriptions') {
								return A2(
									_elm_lang$html$Html$map,
									_user$project$Main$SubscriptionsSwitch,
									_user$project$Subscriptions_Subscriptions$view(_p10._0));
							} else {
								return A2(
									_elm_lang$html$Html$div,
									{ctor: '[]'},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(
											_elm_lang$core$Basics$toString(model.tab)),
										_1: {ctor: '[]'}
									});
							}
						}(),
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"message":"Main.Msg","aliases":{"Podcast.PodcastDescription":{"type":"{ author : String , description : String , image : String , link : String , title : String , url : String }","args":[]},"Subscriptions.Search.SearchTerm":{"type":"String","args":[]},"Subscriptions.Search.PodcastDescription":{"type":"{ author : String , description : String , image : String , link : String , title : String , url : String }","args":[]},"Subscriptions.Search.Model":{"type":"{ searchParam : String , searchResult : Subscriptions.Search.Search , fetchQue : List String , podcasts : List String }","args":[]}},"unions":{"Main.Msg":{"tags":{"SubscriptionsSwitch":["Subscriptions.Subscriptions.Msg"],"SwitchTo":["( Main.Tab, Platform.Cmd.Cmd Main.Msg )"]},"args":[]},"Subscriptions.Subscriptions.Model":{"tags":{"View":["Subscriptions.View.Model"],"Search":["Subscriptions.Search.Model"]},"args":[]},"Subscriptions.Search.Msg":{"tags":{"AddSubscription":["Subscriptions.Search.PodcastDescription"],"UpdateSearchParam":["String"],"SearchPodcasts":["Subscriptions.Search.SearchTerm"],"SearchFail":["String"],"SearchSuccess":["List Subscriptions.Search.PodcastDescription"]},"args":[]},"Subscriptions.View.Model":{"tags":{"Loaded":["List Podcast.PodcastDescription"],"Init":[],"FailedLoad":["String"]},"args":[]},"Subscriptions.Search.Search":{"tags":{"Fetching":[],"SearchResult":["List Subscriptions.Search.PodcastDescription"],"Fail":["String"],"Init":[]},"args":[]},"Result.Result":{"tags":{"Err":["error"],"Ok":["value"]},"args":["error","value"]},"Subscriptions.View.Msg":{"tags":{"LoadPodcasts":["Result.Result String (List Podcast.PodcastDescription)"]},"args":[]},"Platform.Cmd.Cmd":{"tags":{"Cmd":[]},"args":["msg"]},"Main.Tab":{"tags":{"Episodes":[],"Subscriptions":["Subscriptions.Subscriptions.Model"],"Downloads":[]},"args":[]},"Subscriptions.Subscriptions.Msg":{"tags":{"ToggleView":[],"ViewMsg":["Subscriptions.View.Msg"],"SearchMsg":["Subscriptions.Search.Msg"]},"args":[]}}},"versions":{"elm":"0.18.0"}});
}
